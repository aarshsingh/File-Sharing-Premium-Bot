...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        k = await client.send_message(chat_id=message.from_user.id, text=f"<b>❗️ <u>IMPORTANT</u> ❗️</b>\n\nThis video / file will be deleted in 10 minutes.\n\n📌 Due to safety purpose.")
        ...
        await client.send_message(
            ...
            text="Due to safety, the content has been deleted successfully. If you want it again, hit the Watch Again button below.",
